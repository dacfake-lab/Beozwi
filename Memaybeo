...
local Window = OrionLib:MakeWindow({
    ...
    HidePremium = false, 
    SaveConfig = true, 
    ConfigFolder = "OrionOnePiece"
})

-- 2. THÔNG BÁO CHÀO MỪNG
OrionLib:MakeNotification({
    Name = "Đăng Nhập Thành Công!", 
    Content = "Chào mừng bạn đến với Script của beozwi", 
    Image = "rbxassetid://4483345998", 
    Time = 5
})

-- 3. TAB THÔNG TIN BẢN QUYỀN
...
InfoTab:AddParagraph("Chủ sở hữu","Script được chỉnh sửa & sở hữu bởi beozwi")
InfoTab:AddParagraph("Tựa game hỗ trợ","One Piece: Final Chapter")
InfoTab:AddParagraph("Phiên bản","v1.0 Private")

-- 4. TAB CHỨC NĂNG CHÍNH
